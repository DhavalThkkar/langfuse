...
const EnvSchema = z.object({
  ...
  LANGFUSE_AZURE_SKIP_CONTAINER_CHECK: z
    .enum(["true", "false"])
    .default("true"),
  /** User-assigned managed identity client ID for Blob access (AKS: often same as Workload Identity AZURE_CLIENT_ID). */
  LANGFUSE_AZURE_MANAGED_IDENTITY_CLIENT_ID: z.string().optional(),
